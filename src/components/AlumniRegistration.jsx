...
import studentImage from "../assets/Alumniait.png";
        ...
        <div className="email-grp">
          <div className="email-input">
            ...
            <div className="email-label">
              ...
              <input type="date" name="passingyear" id="passingyear" />
            </div>
          </div>
        </div>
        <div className="email-grp">
          <div className="email-input">
            <div className="email-label">
              <label htmlFor="companyName" className="contactInfo">
                Company Name
              </label>
              <input type="text" name="companyName" id="companyName" />
            </div>
            <div className="email-label">
              <label htmlFor="salary" className="contactInfo">
                Salary
              </label>
              <input type="number" name="salary" id="salary" />
              <label htmlFor="salary" id="Email">
                per anum
              </label>
            </div>
          </div>
